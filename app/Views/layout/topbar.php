    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="mr-2 d-none d-lg-inline text-white">
          Halo, <b><?php echo session()->get('nama_lengkap'); ?></b>
        </span>
        <img class="img-profile rounded-circle" src="<?= base_url(); ?>/img/undraw_profile.svg" />
      </a>
      <!-- Dropdown - User Information -->
      <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        <button type="button" class="btn dropdown-item btn-sm" id="btnProfile" role="button" data-bs-toggle="modal" data-bs-target="#myProfileModal" data-id="<?= session()->get('id_user'); ?>" data-nama="<?= session()->get('nama_lengkap'); ?>" data-email="<?= session()->get('email'); ?>" data-username="<?= session()->get('username'); ?>" data-password="<?= session()->get('password'); ?>" data-alamat="<?= session()->get('alamat'); ?>" data-telp="<?= session()->get('telp'); ?>" data-tipe="<?= session()->get('tipe_akun'); ?>">
        ...
        <a class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#logoutModals">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="input-group" id="passwordVisibility">
                <input type="password" name="passUser" id="passUser" class="form-control" readonly />
                <div class="input-group-append">
                  <button class="btn btn-outline-secondary toogle-password btnTooglePassword" type="button">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="textarea" name="telpUser" id="telpUser" class="form-control" readonly />
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="textarea" name="tipeAkunUser" id="tipeAkunUser" class="form-control" readonly />
            </div>
          </div>
        </div>
      ...
      <div class="d--sm-flex modal-footer mb-4">
        <button type="submit" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editProfileModal" data-bs-dismiss="modal" name="changePassword">
