            ...
            <?php foreach ($masuk as $msk) : ?>
              <tr>
                ...
                <td>
                  ...
                  <button type="submit" id="btnInfo" class="btn btn-info mr-2" href="/user/detail_barang_masuk">
