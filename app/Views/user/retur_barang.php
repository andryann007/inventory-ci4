            ...
            <?php foreach ($retur as $rtr) : ?>
              <tr>
                ...
                <td class="d-sm-flex" style="justify-content: center;">
                  ...
                  <button type="submit" id="btnInfo" class="btn btn-info mr-2" href="/user/detail_retur_barang">
