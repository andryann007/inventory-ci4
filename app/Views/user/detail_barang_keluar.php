      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <?= form_open('user/save_detail_keluar', ['class' => 'formSimpanBarangKeluar']);?>
            ...
            >
              <h2 class="h3 text-gray-800 col-md-9">Detail Barang Keluar</h2>
                      ...
                      <tr>
                        ...
                        >
                          <button
                            ...
                            data-toggle="modal"
                            data-target="#editOutcomingDetail"
                            data-id_barang="<?= $klr['id_barang'];?>"
                            data-qty_keluar="<?= $klr['qty_keluar'];?>"
                            data-harga_satuan="<?= $klr['harga_satuan_keluar'];?>"
        ...
        $('.formSimpanBarangKeluar').submit(function(e){
          ...
          $.ajax({
            ...
            success: function(response){
              if(response.success){
                window.location.href = ("<?= site_url('user/keluar'); ?>");
              }
            },
  ...
  >
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <form action="/user/update_detail_keluar" method="post">
