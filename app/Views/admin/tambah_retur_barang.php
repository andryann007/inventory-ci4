      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <?= form_open('admin/save_retur', ['class' => 'formSimpanReturBarang']);?>
            ...
            >
            <h2 class="h3 text-gray-800 col-md-9">Tambah Data Retur Barang</h2>
            ...
            <tbody class="formTambahBarang">
                <tr>
                <td><input type="date" name="tglRetur[]" class="form-control" required/></td>
