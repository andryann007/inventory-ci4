...
<div class="container-fluid">
  ...
  <div style="justify-content: space-between; align-items: center; margin-bottom:10px;" class="d-none d-flex">
    ...
    <a href="<?php echo site_url('/admin/stock'); ?>" class="btn btn-dark btn-md" role="button"><i class="fas fa-eye"></i> <span class="d-none d-md-inline">All Data</span></a>
