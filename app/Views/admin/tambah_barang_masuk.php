      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <?= form_open('admin/save_masuk', ['class' => 'formSimpanBarangMasuk']);?>
            ...
            >
              <h2 class="h3 text-gray-800 col-md-9">Tambah Data Barang Masuk</h2>
            ...
            >
              ...
              <tbody class="formTambahBarang">
                <tr>
                  <td><input type="date" name="tglIncoming[]" class="form-control" required/></td>
                  <td><select class="form-control" name="namaSupplier[]" required>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a
            ...
            href="<?php echo site_url('/admin/logout');?>"
          >
