            ...
            <?php foreach ($keluar as $klr) : ?>
              <tr>
                ...
                <td class="d-sm-flex" style="justify-content: center;">
                  ...
                  <button type="submit" id="btnInfo" class="btn btn-info mr-2" href="/admin/detail_barang_keluar">
