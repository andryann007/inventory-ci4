            ...
            <?php foreach ($masuk as $msk) : ?>
              <tr>
                ...
                <td>
                  ...
                  <button type="submit" id="btnInfo" class="btn btn-info mr-2" href="/admin/detail_barang_masuk">
