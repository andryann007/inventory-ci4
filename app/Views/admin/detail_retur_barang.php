...
<div class="container-fluid">
  <?= form_open('admin/save_detail_retur', ['class' => 'formSimpanReturBarang']); ?>
  ...
  <div style="justify-content: space-between; align-items: center; margin-bottom:10px;" class="d-none d-flex">
    ...
    <a class="btn btn-danger btn-sm btnBack" href="/admin/retur">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div class="d-sm-flex align-items-center justify-content-between">
        ...
        <div class="col-md-1">
          <form action="/admin/print_retur" method="post">
...
<div class="modal fade" id="editReturningDetail" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <form action="/admin/update_detail_retur" method="post">
    ...
    $('.formSimpanReturBarang').submit(function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.success) {
            window.location.href = ("<?= site_url('admin/retur'); ?>");
          }
        },
