      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <?= form_open('admin/save_detail_masuk', ['class' => 'formSimpanBarangMasuk']);?>
            ...
            >
            <h2 class="h3 text-gray-800 col-md-9">Detail Barang Masuk</h2>
                ...
                >
                    ...
                    <tr>
                        ...
                        <button
                            ...
                            data-toggle="modal"
                            data-target="#editIncomingDetail"
                            data-id_barang="<?= $msk['id_barang'];?>"
                            data-qty_masuk="<?= $msk['qty_masuk'];?>"
                            data-harga_satuan="<?= $msk['harga_satuan_masuk'];?>"
        ...
        $('.formSimpanBarangMasuk').submit(function(e){
          ...
          $.ajax({
            ...
            success: function(response){
              if(response.success){
                window.location.href = ("<?= site_url('admin/masuk'); ?>");
              }
            },
  ...
  >
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <form action="/admin/update_detail_masuk" method="post">
