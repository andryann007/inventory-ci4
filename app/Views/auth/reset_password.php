                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="token" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter Your Reset Token..." required maxlength="12">
                                        </div>

                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user"
                                                id="inputPassword" placeholder="Enter New Password..." required maxlength="12">
                                        </div>

                                        <div class="form-group">
                                            <input type="password" name="confirmPassword" class="form-control form-control-user"
                                                id="inputConfirmPassword" placeholder="Confirm New Password..." required maxlength="12">
                                        </div>
