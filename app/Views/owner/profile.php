      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="col bg-light">
            ...
            <div class="row">
              <div class="col-md-6">
                <h1 class="h5 mt-2 mb-4 text-dark">Nama Lengkap : <b><?php echo session()->get('nama_lengkap'); ?></b></h1>
              </div>

              <div class="col-md-6">
                <h1 class="h5 mt-2 mb-4 text-dark">Email : <b><?php echo session()->get('email'); ?></b></h1>
              </div>

              <div class="col-md-6">
                <h1 class="h5 mt-2 mb-4 text-dark">Username : <b><?php echo session()->get('username'); ?></b></h1>
              </div>

              <div class="col-md-6">
                <h1 class="h5 mt-2 mb-4 text-dark">Password : <b><?php echo session()->get('password'); ?></b></h1>
              </div>

              <div class="col-md-6">
                <h1 class="h5 mt-2 mb-4 text-dark">Telp : <b><?php echo session()->get('telp'); ?></b></h1>
              </div>

              <div class="col-md-6">
                <h1 class="h5 mt-2 mb-4 text-dark">Tipe Akun : <b><?php echo session()->get('tipe_akun'); ?></b></h1>
              </div>

              <div class="col-md-12">
                <h1 class="h5 mt-2 mb-4 text-dark">Alamat : <b><?php echo session()->get('alamat'); ?></b></h1>
              </div>
            </div>
          </div>
        </div>
