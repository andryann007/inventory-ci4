...
<html lang="en">
  ...
  <body id="page-top">
                      ...
                      <tr>
                        ...
                        >
                          <button
                            ...
                            data-id="<?= $cs['id_customer'];?>"
                            data-nama="<?= $cs['nama_customer'];?>"
                            data-email="<?= $cs['email'];?>"
                            data-alamat="<?= $cs['alamat'];?>"
                            data-telp="<?= $cs['telp'];?>"
                          >
                          ...
                          <button
                            ...
                            id="btnDelete"
                            data-toggle="modal"
                            data-target="#deleteCustomerModel"
                            data-id="<?= $cs['id_customer'];?>"
                          >
    ...
    <script>
      $(document).on('click', '#btnEdit', function(){
        $('.modal-body #idCustomer').val($(this).data('id'));
        $('.modal-body #namaCustomer').val($(this).data('nama'));
        $('.modal-body #alamatCustomer').val($(this).data('alamat'));
        $('.modal-body #emailCustomer').val($(this).data('email'));
        $('.modal-body #telpCustomer').val($(this).data('telp'));
      })

      $(document).on('click', '#btnDelete', function(){
        $('.modal-footer #idCustomer').val($(this).data('id'));
      })
    </script>
  </body>
 ...
 <div
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form action='/owner/save_customer' method="post">
          <div class="modal-body">
          ...
          <div class="d-sm-flex modal-footer mb-4">
            ...
            <button type="submit" class="btn btn-primary" name="addNewCustomer">
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action='/owner/update_customer' method="post">
          <div class="modal-body">
            <div class="form-group">
              <label for="idCustomer">ID Customer</label>
              <input
  ...
  >
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form action="/owner/delete_customer" method="post">
