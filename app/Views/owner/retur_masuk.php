      ...
      >
        ...
        <li class="nav-item active">
          <a class="nav-link" href="/owner/masuk">
            ...
            <span>Data Retur Barang Masuk</span></a
          >
        </li>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h2 class="h3 mb-0 text-gray-800 col-md-8">
                Data Retur Barang Masuk
              </h2>
              <a href="/owner/masuk" class="btn btn-info btn-sm" role="button"
                ><i class="fas fa-file"></i> Barang Masuk</a
              >
                ...
                <div class="table-responsive table-striped">
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      $dataStock = mysqli_query($conn, "SELECT * FROM data_barang_masuk masuk, data_stock stock WHERE stock.id_barang = masuk.id_barang AND jenis_transaksi = 'retur_pembelian'");
                      $i = 1;
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addModalLabel">
            Tambah Data Retur Barang Masuk
          </h5>
          <button
            type="button"
            class="close"
