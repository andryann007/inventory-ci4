...
<div class="container-fluid">
  ...
  <div style="justify-content: space-between; align-items: center; margin-bottom:10px;" class="d-none d-flex">
    ...
    <a class="btn btn-danger btn-md mr-2 btnBack" href="/owner/keluar">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div style="justify-content: space-between; align-items: center;" class="d-none d-flex">
        <h6 class="col-md-8 font-weight-bold text-primary">
          Detail Barang Keluar
        </h6>
        <?= form_open('/owner/print_keluar'); ?>
        <?= csrf_field(); ?>
...
<div class="modal fade" id="editOutcomingDetail" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <?= form_open('/owner/update_detail_keluar'); ?>
      <?= csrf_field(); ?>
